...
class DependencyUpdatePolicyTests(unittest.TestCase):
    def test_rust_181_dependencies_stay_on_compatible_release_lines(self) -> None:
        ...
        self.assertIn('url = { version = "2.5.4"', backend)
        self.assertIn('idna_adapter = { version = "=1.2.0"', backend)
        ...
        self.assertIn('name = "idna_adapter"\nversion = "1.2.0"', lockfile)
        self.assertNotIn('name = "idna"\nversion = "0.5.0"', lockfile)
    ...
    def test_dependabot_ignores_only_incompatible_update_classes(self) -> None:
        ...
        self.assertNotIn("- dependency-name: url", dependabot)
        self.assertIn("- dependency-name: idna_adapter", dependabot)
        self.assertIn('versions: [">= 1.2.1"]', dependabot)
