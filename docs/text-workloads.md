...
> **Availability:** this workflow is included in Pari 0.3.0 and newer source distributions. Install `pari-similarity==0.3.0` or the current checkout before running it.
